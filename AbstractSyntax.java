...
//	System.out.println("Declarations: ");
    ...
    //System.out.print("Declarations = {");//반드시 수정!!!!!!!!!!
	for (int i = 0; i < size()-1; i++) {
		get(i).display(++k);
	}
	get(size()-1).display(0);
    //System.out.println("}");
    }
}
...
class Assignment extends Statement {
	...
	System.out.println("=");//joo assignment -> =
	target.display(++k);
	source.display(k);
    }
...
class Variable extends Expression {
	...
	System.out.println(id);//joo "Variable " + 
    }
}
...
class BoolValue extends Value {
	...
	//System.out.print("BoolValue: ");joo
	System.out.println(value);
    }
...
class CharValue extends Value {
	...
	//System.out.print("CharValue: "); joo
	System.out.println(value);
    }
